...
-   [Predicting nonlinear BMD changes over time](#predicting-nonlinear-bmd-changes-over-time)
...
-   [Using OpenBoneMin](#using-openbonemin)
    -   [Install from GitHub as an R package](#install-from-github-as-an-r-package)
